...
def main(self, cookie, url, config):
    ask = raw_input('\n     \x1b[0;97m    [\x1b[0;95m\xe2\x80\xa2\x1b[0;97m]\x1b[0;92m Nawk Dane : PROFISOR \x1b[0;97m[\x1b[0;95m\xe2\x80\xa2\x1b[0;97m]\n\n \x1b[0;97m[\x1b[0;91m?\x1b[0;97m] Masukan Nama \x1b[0;91m:\x1b[0;96m ')
    if ask.strip() == '':
    ...
    statusStop = False
    output = 'user/' + ask.replace(' ', '_') + ('.json').strip()
    id = []
    print ''
    while True:
        try:
            ...
            for i in find:
                ...
                if '+' in str(name) or name == None:
                    ...
                    sys.stdout.write('\x1b[0;90m>>>\x1b[0;96m %s                                        \r\n\x1b[0;97m[\x1b[0;92m%s\x1b[0;97m] [\x1b[0;96m%s\x1b[0;97m] \033[1;91mSERVER ViP\033[1;97m ' % (
